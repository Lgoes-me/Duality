...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController {
        ...
        private void GatherInput() {
            ...
            var inputAction = PlayerInputActions.FindAction("Jump");
            var buttonControl = (ButtonControl)inputAction.controls[0];
            var horizontal = PlayerInputActions.Player.Move.ReadValue<Vector2>().x;

            Animator.SetFloat("Speed", Mathf.Abs(horizontal));

            Input = new FrameInput {
                JumpDown = buttonControl.wasPressedThisFrame,
                JumpUp = buttonControl.wasReleasedThisFrame,
                X = horizontal
            };
            if (Input.JumpDown) {
